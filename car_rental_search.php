                ...
                <div class="row justify-content-center">
                        <div class="about-content-box text-center mb-2 wow fadeInDown">
                            <div class="section-title mb-30">
                                ...
                                <h2 >Vehicles for Brand : <?php   echo $brand;  ?>  & Fuel type: <?php   echo $fueltype;  ?></h2>
...
$query = "SELECT * FROM car_rental where car_brand='$brand' and car_fuel_type='$fueltype'";
$result = mysqli_query($conn, $query);
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<p>No cars available for rent according  brand and Fueltype you have filtered.</p>';
}
?>
