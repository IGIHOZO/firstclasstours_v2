...
include("head.php"); 
$room_type_post = isset($_GET['room_type_post']) ? $_GET['room_type_post'] : '';
$hotel_star_rating_post = isset($_GET['hotel_star_rating_post']) ? $_GET['hotel_star_rating_post'] : '';
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                        <div class="about-content-box text-center mb-2 wow fadeInDown">
                            ...
                            <h2 >Available  Rooms: <?php   echo $room_type_post;  ?>  & Star Rating: <?php   echo $hotel_star_rating_post;  ?><i class="fa fa-star" style="color: gold;"></i></h2>
...
$query = "SELECT * FROM hotel_rooms,hotels where hotel_rooms.hotel_id=hotels.id
and room_type='$room_type_post' and room_hotel_star='$hotel_star_rating_post' order by room_id desc";
$result = mysqli_query($conn, $query);
...
if (mysqli_num_rows($result) > 0) {
        ...
        <div class="col-xl-4 col-md-6 col-sm-12 places-column">
            <div class="single-place-item mb-60 wow fadeInUp">
                ...
                <div class="place-content">
                    <div class="info">
                        <h4 class="title"><a href="room_details.php?rid=' .  $RoomID . '">' . $room_name . '</a></h4>
                        <h4 class="title"> Hotel: <a href="room_details.php?rid=' .  $RoomID . '">' . $hotel_name . '</a></h4>
                        ...
                        <div class="text-center meta">
                            <span><a href="room_details.php?rid=' .  $RoomID . '">View Room Details<i class="far fa-long-arrow-right"></i></a></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    echo '<p>No Room available according to your filter.</p>';
}
?>
