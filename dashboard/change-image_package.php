                    ...
                    <div class="grid-form1">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" name="package" method="post" action="update_package_image.php" enctype="multipart/form-data">
                                    
                                    
                                    <?php
                                    
                                    $package_id= $_REQUEST['packageid'];
 $q = mysqli_query($conn, "SELECT * FROM packages where package_id='$package_id'");
...
if (mysqli_num_rows($q) > 0) {
     ...
     $package_image = $row['package_image'];
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <img src="/assets/img/uploads/packages/<?php echo $package_image;?>" width="200">
                                        </div>
                                    </div>
