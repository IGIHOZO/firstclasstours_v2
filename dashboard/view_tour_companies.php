...
<table class="table table-striped">
    ...
    <tbody>
        <?php include("fetch_tour_companies.php"); // Fetch and display data ?>
    </tbody>
</table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tourModalLabel">Tour Company Details</h5>
      ...
      <div class="modal-body">
        ...
        <p><strong>Tour Type:</strong> <span id="modalTourType"></span></p>
        <p><strong>Languages:</strong> <span id="modalLanguages"></span></p>
        <p><strong>License Number:</strong> <span id="modalLicenseNumber"></span></p>
    ...
    $.ajax({
        url: 'fetch_tour_company_info.php', // URL of this PHP file
        method: 'POST',
        data: { id: companyId },
        success: function(response) {
            var company = JSON.parse(response);
            if (company.error) {
                alert(company.error); // Handle errors
            } else {
                ...
                $('#modalTourType').text(company.tour_type);
                $('#modalLanguages').text(company.language_by_tour_guide);
                $('#modalLicenseNumber').text(company.licence_number);
                $('#modalDescription').text(company.service_description);
            }
        }
    });
});
