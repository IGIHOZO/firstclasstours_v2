    ...
    <div id="page" class="full-page">
        ...
        <main>
            ...
            <section class="section py-120">
                <div class="container">
                    <div class="section-header text-center">
                        <h2 class="section-title" id="aboutDv">About Us</h2>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <img style="border-radius: 15%" src="dashboard/<?= $AboutImage ?>" alt="About Us Image" class="img-fluid rounded shadow">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="section py-120 bg-light">
                <div class="container">
                    <div class="section-header text-center">
                        <h2 class="section-title" id="bg">Our Background</h2>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-lg-1">
                            <img style="border-radius: 15%" src="dashboard/<?= $BackgroundImage ?>" alt="Background Image" class="img-fluid rounded shadow">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="section py-120">
                <div class="container">
                    <div class="section-header text-center">
                        <h2 class="section-title" id="mssn">Our Mission</h2>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <img style="border-radius: 15%" src="dashboard/<?= $MissionImage ?>" alt="Mission Image" class="img-fluid rounded shadow">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="section py-120 bg-light">
                <div class="container">
                    <div class="section-header text-center">
                        <h2 class="section-title" id="vssn">Our Vision</h2>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-lg-1">
                            <img style="border-radius: 15%" src="dashboard/<?= $VisionImage ?>" alt="Vision Image" class="img-fluid rounded shadow">
                        </div>
                    </div>
                </div>
            </section>
